...
public class ReflectingTurtle implements Turtle{
    ...
    public ReflectingTurtle(String name, int x, int y, Direction direction, Pen pState, Paper paper){
      this.x = x;
      this.y = y;
      this.name = name;
