...
public class WrappingTurtle implements Turtle{
  ...
  public WrappingTurtle(String name, int x, int y, Direction direction, Pen pState, Paper paper){
    this.x = x;
    this.y = y;
    this.name = name;
