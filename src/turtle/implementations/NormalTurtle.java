...
public class NormalTurtle extends AbstractTurtle{
  ...
  public NormalTurtle(String name, int x, int y, Direction direction, Pen pState,
      Paper paper) {
    super(name, x, y, direction, pState, paper);
  }

  /*
    public NormalTurtle(String name, int x, int y, Direction direction, Pen pState, Paper paper){
      this.x = x;
      this.y = y;
      this.name = name;
